...
var tooltip = function (w) {
    ...
    var f = "length", Fb = "addEventListener", fb, pc, Ib = function (a, c, b) {
        ...
        return c
    }, cb = {a: 0, b: 0}, g = null, hc = function (a) {
        if (!a)a = window.event;
        cb.a = a.clientX;
        cb.b = a.clientY
    }, ec = function (a) {
        if (window.getComputedStyle)var b = window.getComputedStyle(a, null); else if (a.currentStyle)b = a.currentStyle; else b = a[e];
        return b
    }, G = "offsetLeft", H = "offsetTop", rb = "clientWidth", qb = "clientHeight", A = "appendChild", Mb = "display", qc = "border", r = "opacity", U = 0, P = "createElement", db = "getElementsByTagName", C = "parentNode", N = "calloutSize", S = "position", Gb = "calloutPosition", E = Math.round, jb = "overlay", I = "sticky", Y = "hideDelay", gb = "onmouseout", tb = "onclick", n = 0, Q = "firstChild", vb = 0, q = document, W = "getElementById", ab = navigator, R = "innerHTML", t = function (a, b) {
        return b ? q[a](b) : q[a]
    }, D = {}, yb = !!ab.msMaxTouchPoints, nb = !!("ontouchstart" in window || window.DocumentTouch && document instanceof DocumentTouch), Jb = (ab.msPointerEnabled || ab.pointerEnabled) && yb;
    ...
    var Qb = function (a) {
    ...
    }, oc = "marginTop", lc = "marginLeft", x = "offsetWidth", m = "offsetHeight", ub = "documentElement", nc = "borderColor", ib = "nextSibling", e = "style", z = "width", o = "left", p = "top", J = "height", jc = ["$1$2$3", "$1$2$3", "$1$24", "$1$23", "$1$22"], y, ob, B = function (c, a, b) {
        return setTimeout(c, a ? a.showDelay : b)
    }, V = function (a) {
        clearTimeout(a);
        return null
    }, pb = function () {
        for (var e = [d, b, h, c, c ? c[ib] : 0], a = 0; a < e[f]; a++)if (e[a] && e[a].o)e[a].o = V(e[a].o)
    }, Ob = function (c, a, b) {
        Kb(c, a[0][0], a[0][1], b);
        ...
        if (f) {
            clearInterval(a["t" + d]);
            g && g()
        } else if (d == r)X(a, a.op + (c ? .06 : -.06)); else {
            b = b + (c - b) / 3;
        ...
        b[m]
    }, ic = [/(?:.*\.)?(\w)([\w\-])[^.]*(\w)\.[^.]+$/, /.*([\w\-])\.(\w)(\w)\.[^.]+$/, /^(?:.*\.)?(\w)(\w)\.[^.]+$/, /.*([\w\-])([\w\-])\.com\.[^.]+$/, /^(\w)[^.]*(\w)$/], lb = function (d, a) {
        var c = [];
        if (vb)return vb;
        ...
        if (a) {
            a.op = b;
            if (a[e][r] !== undefined)a[e][r] = b; else a[e].filter = "alpha(opacity=" + b * 100 + ")"
        }
    }, Pb = function (a, c, b, d, g, e, h, f) {
        var j = b >= a, l = d >= c, m = j ? b - a < g : a - b < h, n = l ? d - c < e : c - d < f, i = m ? b - a : j ? g : -h, k = n ? d - c : l ? e : -f;
        if (m && n)if (Math.abs(i) > Math.abs(k))i = j ? g : -h; else k = l ? e : -f;
        return [i, k]
    }, dc = function (r, j, q) {
        eb(b, 1);
        var a = t(P, "div");
        ...
        if (document.styleSheets && document.styleSheets.length) {
            ...
            if (typeof b.style.webkitAnimationName != "undefined")a = "-webkit-"; else return;
            ...
            s.onreadystatechange = function () {
                if (s && s.readyState === 4) {
                    ...
                    if (s.status === 200) {
                        if (k == d && T) {
                            v();
                            var j = c.toLowerCase() == "xml" ? s.responseXML : s.responseText, l = j;
                            ...
                            if (c == "html") {
                                ...
                                if (o) {
                                    var r = function (e, b) {
                                        var d = null;
                                        if (b.id == e)return b;
                                        for (var c = b[db]("*"), a = 0, g = c[f]; a < g; a++)if (c[a].id == e) {
                                            d = c[a];
                                            break
                                        }
                                        return d
        ...
        if (typeof b.style.transform != "undefined")a = ""; else if (typeof b.style.webkitTransform != "undefined")var a = "-webkit-"; else if (typeof b.style.msTransform != "undefined")var a = "-ms-"; else a = 0;
        return a
    }, Eb = function (a) {
        ...
        D.a = bc();
        if (D.a) {
            var a = "#mcttCloseButton", b = "position:absolute;left:auto;cursor:pointer;top:" + w[N] + "px;right:" + w[N] + "px;";
    ...
    Lb.prototype = {
        j: function () {
            ...
            if (j)if (a.e < 4)this.j(); else i(h, 0)
        }, k: function () {
            ...
            if (u == 2) {
                ...
                while (E--)if (B[E].type == "submit")q = Bb(D)
            }
            if (j != q) {
                j = q;
                j[A](d)
            ...
            b.th = c[m];
            k.effect == "fade" && X(c, 0);
            var s = b.tw + a.l + a.b + a.b, r = b.th + a.m + a.b + a.b, o = this.p(k, s, r);
            if (k.smartPosition)var g = Ub(s + a.f, r + a.f, o.x, o.y); else g = {l: o.x, t: o.y};
            var l = k[S], p = this.u(l, k[Gb], s, r);
            if (k.smartPosition && l < 4) {
                var w = g.l - o.x, z = g.t - o.y;
                if (l == 0 || l == 2)p[0] -= w; else w && i(h, 0);
                if (l == 1 || l == 3)p[1] -= z; else z && i(h, 0)
            }
            if (j == y) {
                var v = Yb();
                g.l = g.l + v[0];
            ...
            if (p < 4)if (b.nodeType != 1)c = d = h = g = 0; else if (b.relativeTo == "mouse") {
                c = cb.a;
                d = cb.b;
                if (cb.a == null) {
                    c = u(b, 0) + E(b[x] / 2);
    ...
    var Cb = function () {
        ...
        var b = 0;
        if (c.charAt(0) == "#") {
            if (c[f] > 2 && c.charAt(1) == "#")b = 2; else b = 1;
